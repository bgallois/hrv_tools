...
sensor_rate = 100
resample_rate = 500
data = pd.read_csv(sys.argv[1], header=None, names=["red", "ir"])
...
data.red = scipy.signal.savgol_filter(data.red, int(20*1e-3*resample_rate), 2) # 20ms window
...
confidence = 0.1 # Windows with more than confidence*100 % of artefact will be removed
